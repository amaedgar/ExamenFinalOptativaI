...
rojo_img = pygame.image.load("fondo_violeta.png")
azul_img = pygame.image.load("fondo_amarillo.png")
...
while True:       
    ...
    if jugado:
        if estado == -1:
            ...
            message = fuente.render("Ganaste", True, (255,255,255))
        elif estado == 2:
            message = fuente.render("Perdiste", True, (255,255,255))
    ...
    if estado == 3: #game over
        ...
        if score_jugador == score_ia:
           ...
           winner = fuente.render("¡¡¡Ganaste!!!", True, (0,255,0))
        else:
            winner = fuente.render("¡¡¡Perdiste!!!", True, (203,40,33))
